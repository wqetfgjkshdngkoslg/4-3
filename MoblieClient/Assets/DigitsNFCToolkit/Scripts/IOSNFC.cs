...
namespace DigitsNFCToolkit
{
	...
	public class IOSNFC: NativeNFC
	{
		...
		[DllImport("__Internal")]
		private static extern void _nativeNFC_setUseNDEFReaderSession(bool useNDEFReaderSession);
		[DllImport("__Internal")]
		...
		public override bool UseNDEFReaderSession
		{
			get { return base.UseNDEFReaderSession; }
			set 
			{ 
				base.UseNDEFReaderSession = value;
				_nativeNFC_setUseNDEFReaderSession(useNDEFReaderSession);
			}
		}
