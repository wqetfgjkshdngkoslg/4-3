...
namespace DigitsNFCToolkit
{
	...
	public abstract class NativeNFC: MonoBehaviour
	{
		...
		/// <summary>(iOS only) Indicates whether to use the old NDEF Reader Session, needed for some nfc tags/cards with older formats (https://stackoverflow.com/questions/72207899/how-to-get-aid-for-a-specific-nfc-tag)</summary>
		protected bool useNDEFReaderSession;
		...
		/// <summary>(iOS only) Indicates whether to use the old NDEF Reader Session, needed for some nfc tags/cards with older formats (https://stackoverflow.com/questions/72207899/how-to-get-aid-for-a-specific-nfc-tag)</summary>
		public virtual bool UseNDEFReaderSession
		{
			get { return useNDEFReaderSession; }
			set { useNDEFReaderSession = value; }
		}
